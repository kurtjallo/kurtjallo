...
| **HAVN** | Privacy-first social platform — full product from architecture to go-to-market | React Native, FastAPI, PostgreSQL, AWS, Docker | [Org](https://github.com/HAVN-Inc) |
...
| **Clarify** | RAG-powered document analysis — upload any doc and ask questions with cited answers | Next.js, Python, MongoDB Atlas Vector Search, Cohere | [Repo](https://github.com/kurtjallo/Clarify-Hackville-2026) |
